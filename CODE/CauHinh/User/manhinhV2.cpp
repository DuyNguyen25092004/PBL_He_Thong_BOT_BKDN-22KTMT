#include<iostream>
#include "C:/Users/MSI PC/Desktop/pbl_adjust/Minh-vs-DuyNguyen/CauHinh/Admin/gotoxy.cpp"
#include "User.cpp"
#include <fstream>
#include<algorithm>
using namespace std;
...
void IOtaikhoan(){
    info.open("C:/Users/MSI PC/Desktop/pbl_adjust/Minh-vs-DuyNguyen/CauHinh/User/tai_khoan.txt",ios::in);
    Account temp;
    string ten_temp;
    string cccd_temp;
...
void BOT::updateAC(){
    info.open("C:/Users/MSI PC/Desktop/pbl_adjust/Minh-vs-DuyNguyen/CauHinh/User/tai_khoan.txt", ios::out);
    ...
    info.close();
    info.open("C:/Users/MSI PC/Desktop/pbl_adjust/Minh-vs-DuyNguyen/CauHinh/Admin/txt/bienso.txt",ios::out);
    for(int i=0;i<account_main.size();i++){
        info<<account_main[i].second.second.second.first.BienSo<<"\n";
        info<<account_main[i].second.second.second.second<<"\n";
    }
...
void BOT:: DangKi(){
    Account ptr;
    info.open("C:/Users/MSI PC/Desktop/pbl_adjust/Minh-vs-DuyNguyen/CauHinh/User/tai_khoan.txt", ios::app);
    int check =0; 
        system("cls");
     check=0;
